%MCEN90018 - Advanced Fluid Dynamics - Assignment 2 - Q2
% This script answers Question 2 in the Assignment 2 sheet.
...
title("Comparison of theoretical vs numerical C_p for 8-panel geometry")
grid on
axis([0 2*pi -3 1]);
